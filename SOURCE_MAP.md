...
| Klenke 5.34 | Empirical CDF and Glivenko–Cantelli | `Probability/EmpiricalProcess/CDF.lean`; `StrongLaw.lean` | Finite-sample API and pointwise a.s. convergence on one common event for every real threshold implemented; uniform a.s. theorem remains |
