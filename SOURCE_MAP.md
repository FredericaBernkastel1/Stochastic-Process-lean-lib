...
| Klenke 5.34–5.36 | Poisson-process characterization and constructions | `Probability/Process/Poisson/Basic.lean`; `IntervalAxioms.lean`; `Constructions.lean` | Exact P1–P5 interval-count predicate and the forward implication from a Poisson process implemented, including the exact `limsup` form of P5; the converse characterization and construction probability laws remain. Deterministic construction cores include arrival/count inversion and right continuity |
...
| Klenke Ch. 6 | Local pseudometric, subsequence and completeness package | `ForMathlib/MeasureTheory/Function/ConvergenceInMeasureLocal.lean`; `FastConvergenceLocal.lean`; `CauchyInMeasureLocal.lean` | Fast-convergence/Borel--Cantelli criteria, sigma-finite a.e. subsequences, every-subsequence characterization, and full Cauchy completeness for complete metric targets implemented; the exhaustion pseudometric remains |
