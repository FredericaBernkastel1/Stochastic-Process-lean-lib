...
Authors: Rémy Degenne, Peter Pfaffelhuber; StochLean adaptation
-/
module

public import StochLean.Internal.KolmogorovExtension.CompactSystem
public import Mathlib.MeasureTheory.Measure.AddContent

@[expose] public section

namespace StochLean.Internal.KolmogorovExtension
...
lemma tendsto_zero_of_regular_addContent (hR : IsSetRing R) (m : AddContent ℝ≥0∞ R)
  ...
  let S := StochLean.Internal.KolmogorovExtension.IsCompactSystem.support
    hC ht_mem_C ht_empty
  have hS := StochLean.Internal.KolmogorovExtension.IsCompactSystem.iInter_eq_empty
    hC ht_mem_C ht_empty
...
end StochLean.Internal.KolmogorovExtension
