...
import StochLean.Internal.Exchangeability.Probability.TripleLawDropInfo.DropInfo
...
lemma pair_law_shift_eq_of_contractable
  ...
  have h_seq_eq : Measure.map seqM μ = Measure.map seqN μ := by
    ...
    apply StochLean.Internal.Exchangeability.measure_eq_of_fin_marginals_eq_prob
    intro r S _hS
