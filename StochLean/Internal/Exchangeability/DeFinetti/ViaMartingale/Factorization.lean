...
import StochLean.Internal.Exchangeability.PathSpace.CylinderHelpers
...
open StochLean.Internal.Exchangeability.PathSpace StochLean.Internal.Exchangeability.DeFinetti.MartingaleHelpers
...
lemma block_coord_condIndep
  ...
  apply StochLean.Internal.Exchangeability.Probability.condIndep_of_indicator_condexp_eq
...
lemma condexp_indicator_inter_of_condIndep
  ...
  StochLean.Internal.Exchangeability.Probability.condexp_indicator_inter_bridge hm hmF hmH hCI hA hB
...
lemma tail_factorization_from_future
  ...
  have h_lhs_conv : ∀ᵐ ω ∂μ,
    ...
    have h_conv := StochLean.Internal.Exchangeability.Probability.condExp_tendsto_iInf
      (μ := μ)
