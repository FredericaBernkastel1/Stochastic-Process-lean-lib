...
open StochLean.Internal.Exchangeability.PathSpace
...
lemma finite_product_formula_id
  ...
  have h_agree :
    ...
    have h_conv : ∀ i : Fin m,
      ...
      intro i
      have := StochLean.Internal.Exchangeability.Probability.condExp_tendsto_iInf
        ...
        (h_f_int := by
          simpa using
            StochLean.Internal.Exchangeability.Probability.integrable_indicator_comp
